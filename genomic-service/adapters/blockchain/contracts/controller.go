...
// ControllerGeneNFTMintedIterator is returned from FilterGeneNFTMinted and is used to iterate over the raw logs and unpacked data for GeneNFTMinted events raised by the Controller contract.
type ControllerGeneNFTMintedIterator struct {
	Event *ControllerGeneNFTMinted // Event containing the contract specifics and raw log
...
func (it *ControllerGeneNFTMintedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ControllerGeneNFTMinted)
...
func (it *ControllerGeneNFTMintedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ControllerGeneNFTMintedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ControllerGeneNFTMinted represents a GeneNFTMinted event raised by the Controller contract.
type ControllerGeneNFTMinted struct {
	TokenId *big.Int
	DocId   string
	Raw     types.Log // Blockchain specific contextual infos
}

// FilterGeneNFTMinted is a free log retrieval operation binding the contract event 0x69a6486080e31d087264e475a660483dbd6bf9f1e913a628547995cc87f5aaee.
//
// Solidity: event GeneNFTMinted(uint256 tokenId, string docId)
func (_Controller *ControllerFilterer) FilterGeneNFTMinted(opts *bind.FilterOpts) (*ControllerGeneNFTMintedIterator, error) {

	logs, sub, err := _Controller.contract.FilterLogs(opts, "GeneNFTMinted")
	if err != nil {
		return nil, err
	}
	return &ControllerGeneNFTMintedIterator{contract: _Controller.contract, event: "GeneNFTMinted", logs: logs, sub: sub}, nil
}

// WatchGeneNFTMinted is a free log subscription operation binding the contract event 0x69a6486080e31d087264e475a660483dbd6bf9f1e913a628547995cc87f5aaee.
//
// Solidity: event GeneNFTMinted(uint256 tokenId, string docId)
func (_Controller *ControllerFilterer) WatchGeneNFTMinted(opts *bind.WatchOpts, sink chan<- *ControllerGeneNFTMinted) (event.Subscription, error) {

	logs, sub, err := _Controller.contract.WatchLogs(opts, "GeneNFTMinted")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(ControllerGeneNFTMinted)
				if err := _Controller.contract.UnpackLog(event, "GeneNFTMinted", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseGeneNFTMinted is a log parse operation binding the contract event 0x69a6486080e31d087264e475a660483dbd6bf9f1e913a628547995cc87f5aaee.
//
// Solidity: event GeneNFTMinted(uint256 tokenId, string docId)
func (_Controller *ControllerFilterer) ParseGeneNFTMinted(log types.Log) (*ControllerGeneNFTMinted, error) {
	event := new(ControllerGeneNFTMinted)
	if err := _Controller.contract.UnpackLog(event, "GeneNFTMinted", log); err != nil {
		return nil, err
	}
...
// ControllerPCSPRewardedIterator is returned from FilterPCSPRewarded and is used to iterate over the raw logs and unpacked data for PCSPRewarded events raised by the Controller contract.
type ControllerPCSPRewardedIterator struct {
	Event *ControllerPCSPRewarded // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ControllerPCSPRewardedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ControllerPCSPRewarded)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ControllerPCSPRewardedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ControllerPCSPRewardedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ControllerPCSPRewarded represents a PCSPRewarded event raised by the Controller contract.
type ControllerPCSPRewarded struct {
	User   common.Address
	Amount *big.Int
	Raw    types.Log // Blockchain specific contextual infos
}

// FilterPCSPRewarded is a free log retrieval operation binding the contract event 0x3b9b822a58b7c95e1dca308dcf7dffe37e31ccf9aec7e5800ed262c8d176cb83.
//
// Solidity: event PCSPRewarded(address user, uint256 amount)
func (_Controller *ControllerFilterer) FilterPCSPRewarded(opts *bind.FilterOpts) (*ControllerPCSPRewardedIterator, error) {

	logs, sub, err := _Controller.contract.FilterLogs(opts, "PCSPRewarded")
	if err != nil {
		return nil, err
	}
	return &ControllerPCSPRewardedIterator{contract: _Controller.contract, event: "PCSPRewarded", logs: logs, sub: sub}, nil
}

// WatchPCSPRewarded is a free log subscription operation binding the contract event 0x3b9b822a58b7c95e1dca308dcf7dffe37e31ccf9aec7e5800ed262c8d176cb83.
//
// Solidity: event PCSPRewarded(address user, uint256 amount)
func (_Controller *ControllerFilterer) WatchPCSPRewarded(opts *bind.WatchOpts, sink chan<- *ControllerPCSPRewarded) (event.Subscription, error) {

	logs, sub, err := _Controller.contract.WatchLogs(opts, "PCSPRewarded")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ControllerPCSPRewarded)
				if err := _Controller.contract.UnpackLog(event, "PCSPRewarded", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParsePCSPRewarded is a log parse operation binding the contract event 0x3b9b822a58b7c95e1dca308dcf7dffe37e31ccf9aec7e5800ed262c8d176cb83.
//
// Solidity: event PCSPRewarded(address user, uint256 amount)
func (_Controller *ControllerFilterer) ParsePCSPRewarded(log types.Log) (*ControllerPCSPRewarded, error) {
	event := new(ControllerPCSPRewarded)
	if err := _Controller.contract.UnpackLog(event, "PCSPRewarded", log); err != nil {
		return nil, err
	}
